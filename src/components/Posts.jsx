...
const Posts = (props) => {
  ...
  return (
    <>
      {/*  */}
      <div className="bg-white rounded-full p-2 mt-3 cursor-pointer flex flex-row justify-between items-center w-full bg-opacity-50 backdrop-filter backdrop-blur-md max-w-screen-md hover:scale-125 hover-trigger">
