...
const Button = (props) => {
  ...
  return (
    <div className="mt-2 relative hover-trigger">
      <div className="bg-white rounded-full p-3 m-3 cursor-pointer bg-opacity-50 backdrop-filter backdrop-blur-md backdrop-saturate-150 backdrop-contrast-200 hover:ring-4">
