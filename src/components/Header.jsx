...
const Header = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      <header className="cursor-pointer flex flex-row xsm:w-10/12 sm:w-10/12 md:w-10/12 lg:w-7/12 xl:w-7/12 2xl:w-6/12 3xl:w-4/12 4xl:w-3/12 justify-between items-center bg-opacity-50 mt-5">
